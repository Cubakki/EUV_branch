...
if __name__=="__main__":
    ...
    for stru_f in os.listdir(File_path):
        ...
        try:
            ...
            #生成inp文件
            if Platform=="Slurm":
                input_generator=ORCA_INPUT("!TPSS DEF2-SVP D3BJ OPT",stru_path,ele_num,0,["% PAL NPROCS 14 END\n"])
            else:
                input_generator=ORCA_INPUT("!TPSS DEF2-SVP D3BJ OPT",stru_path,ele_num,0,["% PAL NPROCS 4 END\n"])
